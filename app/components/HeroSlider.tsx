...
const slides = [
    {
        id: 1,
        title: "AI SDR",
        description: "Triagem preditiva e negociação autônoma via WhatsApp.",
    ...
    },
    {
        id: 2,
        title: "Executive BI",
        description: "Dashboards globais que mostram apenas o que dá lucro.",
    ...
    },
    {
        ...
        description: "Jornada de vendas remotas para produtos de R$ 20k+.",
        buttonText: "Ver Case",
    ...
    },
    {
        id: 4,
        title: "Lean Ops",
        description: "Infraestrutura e SLAs rígidos para crescer de 2 a 50 pessoas.",
...
export default function HeroSlider({ isSplashActive = false }: { isSplashActive?: boolean }) {
    ...
    return (
        <section className="relative w-full h-screen bg-black overflow-hidden flex flex-col justify-end pb-12">
                    ...
                    index === currentIndex && (
                        ...
                        >
                            ...
                            <div className="relative z-10 max-w-4xl w-full flex flex-col items-center">
                                <h1 className="text-white font-display text-7xl md:text-8xl lg:text-[110px] font-medium tracking-tight mb-6 leading-none text-center">
                                    {slide.title}
                                </h1>
                                <p className="text-white/90 font-sans text-xl md:text-2xl mb-10 text-center max-w-2xl font-light">
                                    {slide.description}
                                </p>
                                <button className="px-10 py-4 bg-[#F8F9FA] text-black font-sans font-semibold rounded-full hover:scale-105 hover:bg-black hover:text-white transition-all duration-300 text-lg shadow-xl">
                                    {slide.buttonText}
                                </button>
                            </div>
                        </motion.div>
